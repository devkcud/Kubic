...
draw_sprite(sprFakeGame, round(image_index / (0.7 * room_speed)), room_width / 2 + 16, room_height / 2 + 16);
...
draw_text_scribble(32, room_height / 2, "[fa_middle][fa_left][fntScore][rainbow]Enter[/rainbow] para iniciar.[/]");
draw_text_scribble(32, room_height / 2 + 24, "[fa_middle][fa_left][fntScore][rainbow]X[/rainbow] para ir às configurações.[/]");
