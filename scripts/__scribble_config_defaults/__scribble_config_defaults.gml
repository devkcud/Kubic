...
#macro SCRIBBLE_DEFAULT_WOBBLE_ANGLE        20       //Default maximum wobble angle. Larger values cause glyphs to oscillate further to the left and right
#macro SCRIBBLE_DEFAULT_WOBBLE_FREQ         0.13     //Default wobble frequency. Larger values cause glyphs to oscillate faster

#macro SCRIBBLE_DEFAULT_PULSE_SCALE         0.2      //Default pulse scale offset. A value of 0 will cause no visible scaling changes for a glyph, a value of 1 will cause a glyph to double in size
#macro SCRIBBLE_DEFAULT_PULSE_SPEED         0.05      //Default pulse speed. Larger values cause glyph scales to pulse faster
