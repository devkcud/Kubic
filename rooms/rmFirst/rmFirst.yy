{
  ...
  "layers": [
    {"instances":[
        ...
        {"properties":[
            {"propertyId":{"name":"tutorialStrings","path":"objects/objRoomManager/objRoomManager.yy",},"objectId":{"name":"objRoomManager","path":"objects/objRoomManager/objRoomManager.yy",},"value":"[\"Olá, bem-vindo ao tutorial! Aqui você irá aprender as mecânicas básicas do jogo. (Enter para continuar)\", \"Antes de inciar, coloque os blocos na grade clicando com o [pulse]botão esquerdo do mouse[/pulse]. Você [slant]NÃO[/slant] pode\\ncolocar mais do que você tem.\", \"Você pode rotacionar os blocos com as [pulse]teclas \\\"A\\\" e \\\"D\\\"[/pulse].\", \"Quando o modo corrida for ativado, os [wave]blocos com setas verdes [scale, 0.8][sprPush][scale, 1.5][/wave] irão seguir em frente.\", \"Você pode remover os blocos com o [pulse]botão direito do mouse[/pulse].\", \"O objetivo do jogo é coletar todas os blocos com números dentro. Quando estiver pronto, aperte a [pulse]tecla\\\"P\\\"[/pulse]\\npara iniciar o [rainbow]modo corrida[/rainbow] (Isso travará todo o sistema de colocar blocos).\"]","resourceVersion":"1.0","name":"","tags":[],"resourceType":"GMOverriddenProperty",},
